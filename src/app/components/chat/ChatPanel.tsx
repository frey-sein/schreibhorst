            ...
            {isAnalyzing ? (
              ...
              analyzedPrompts.length > 0 ? (
                <div>
                  ...
                  {selectedPrompt && (
                    <div className="mt-3 p-3 mb-3 bg-white border border-gray-200 rounded-lg">
                ...
                <p className="text-sm text-gray-500 mb-3">Keine Prompts gefunden. Versuche, mehr Details in deinem Chat zu besprechen.</p>
              )
            )}
          </div>
        </div>
